...
class DetailScreen_copy extends StatefulWidget {
  final String? taskId;
  final HeroId? heroIds;
  final DietTaskViewModel? model;
  final DietTask? task;
  final int? days;
  const DetailScreen_copy(
...
class DetailScreen_State extends State<DetailScreen_copy>
  ...
  void initState() {
    ...
    setCalendarFormat(widget.task!.days!);
...
*/
  ...
  Widget _buildTableCalendarWithBuilders() {
    return TableCalendar(
      ...
      lastDay: DateTime.utc(2020, 11, widget.task!.days!),
