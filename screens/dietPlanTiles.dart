...
class DietPlanTiles extends StatefulWidget {
  const DietPlanTiles({Key? key, this.gameModel, this.taskModel, this.game})
      : super(key: key);
  ...
  @override
  _DietPlanTilesState createState() => _DietPlanTilesState();
}

class _DietPlanTilesState extends State<DietPlanTiles>
  ...
  void initState() {
    ...
    // loadList();
    //widget.gameModel!.getDietPlanTodos(widget.game!.gameOwnerId, widget.game!);
    handleScroll();
                    ...
                    body: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        children: [
                          ...
                          ...List.generate(
                            widget
                                .game!.planIds!.length, // 4,//myFriends.length,
                            (index) => ItemForGameTile(
                              gameMembers: model.gameMembers,
                              game: widget.game,
                              index: index,
                              planId: widget.game!.planIds![index],
                            ),
                          ),
                        ],
                      )),
...
class ItemForGameTile extends StatelessWidget {
  ...
  ItemForGameTile({this.game, this.planId, this.index, this.gameMembers});
  @override
  Widget build(BuildContext context) {
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => DietPlanReview(
                game: game, enabled: false, dietPlanId: planId,
                //day: _selectedDay!,
              ),
            ));
      },
      child: Card(
        ...
        child: Column(children: [
          ListTile(
            ...
            title: Text(
                game!.title ?? "", //'Diet Plan-' + (index! + 1).toString(),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              // MeCard2(gameOwner!),
                              ...List.generate(
                                  gameMembers!.length, // 4,//myFriends.length,
                                  (index) => Padding(
                                        padding: EdgeInsets.only(
              ...
              child: Container(
                ...
                child: Center(
                  ...
                  Row(children: [
                    SizedBox(width: 20),
                    Lottie.asset(
                      "assets/lottie/cup.json", width: 40, height: 40,
                      //repeat: false,
                    ...
                    child: Container(
                      ...
                      child: Center(
                        ...
                        Row(children: [
                          SizedBox(width: 20),
                          Lottie.asset(
                            "assets/lottie/todo_completed.json", width: 40,
                            height: 40,
                            //repeat: false,
                            //controller:lottieController
                          ),
