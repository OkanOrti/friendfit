...
class _AddTaskScreenForGameState extends State<AddTaskScreenForGame> {
  ...
  void initState() {
    ...
    widget.todoModel?.todoPhrases =
        widget.todom == null ? [] : widget.todom!.phrases!;
    /*  setState(() {
                ...
                children: [
                  ...
                  IconPickerBuilder(
                      ...
                      action: (newIcon) => setState(() => taskIcon = newIcon)),
                          ...
                          Divider(),
                          widget.todoModel!.todoPhrases.length > 0
                              ? Expanded(
                                  child: Padding(
                                    padding:
                    ...
                    floatingActionButton: Builder(
                      builder: (BuildContext context) {
                        return FloatingActionButton.extended(
                          ...
                          label: widget.todoModel!.todoPhrases.isNotEmpty
                              ? const Text(
                                  'Listene ekle',
                                  style: TextStyle(color: Colors.white),
                                )
